        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                @elseif (Auth()->user()->isAdmin == 2)
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('product.index') ? 'active' : '' }}"
                            ...
                            <i class="fas fa-box me-1"></i>Data Produk
                        </a>
                    </li>
                    <li class="nav-item">
                ...
                @elseif (Auth()->user()->isAdmin == 0)
                    <!-- Cashier Menu - Separate Items -->
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('cashier.index') ? 'active' : '' }}"
                            href="{{ route('cashier.index') }}">
                            <i class="bi bi-cart-check me-1"></i>Transaksi
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('expenditures.index') ? 'active' : '' }}"
                            href="{{ route('expenditures.index') }}">
                            <i class="bi bi-cash-stack me-1"></i>Pengeluaran
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('cashier.riwayat') ? 'active' : '' }}"
